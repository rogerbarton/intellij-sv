 ...
 * from the specification file <tt>Sv.flex</tt>
 */
class SvLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return SvTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return SvTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return SvTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return SvTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
